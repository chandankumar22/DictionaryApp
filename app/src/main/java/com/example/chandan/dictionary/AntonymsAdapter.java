...
public class AntonymsAdapter extends ArrayAdapter <ArrayList<String>>
{

    LayoutInflater layoutInflater;
    ArrayList<String> data;
     Context context;
    public AntonymsAdapter(@NonNull Context context, ArrayList data) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Log.d("setted text antonym is",data.get(position));
